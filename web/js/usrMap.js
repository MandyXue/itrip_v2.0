...
var provincesDataProvider;
var backImage = {
    // back button configuration
    svgPath: backIconSVG,
    id: "backButton",
    label: "Back to China Map",
    rollOverColor: "#347C01",
    labelRollOverColor: "#347C01",
    ...
    images: [backImage,
        {
            ...
            color: "#ffffff",
            // set url
            url: "spot?spotName=xiangshawan&province=innermongolia"
        },
        {
            svgPath: targetSVG,
            zoomLevel: 5,
            ...
            color: "#ffffff",
            // set url
            url: "spot?spotName=reshui&province=innermongolia"
        },
        {
            svgPath: targetSVG,
            zoomLevel: 5,
            ...
            color: "#ffffff",
            // set url
            url: "spot?spotName=dizhigongyuan&province=innermongolia"
        },
        {
            svgPath: targetSVG,
            zoomLevel: 5,
            ...
            color: "#ffffff",
            // set url
            url: "spot?spotName=ejinahuyanglin&province=innermongolia"
        },
        {
            svgPath: targetSVG,
            zoomLevel: 5,
            ...
            color: "#ffffff",
            // set url
            url: "spot?spotName=daqinggou&province=innermongolia"
        },
        {
            svgPath: targetSVG,
            zoomLevel: 5,
            ...
            color: "#ffffff",
            // set url
            url: "spot?spotName=xilinguolexilamulun&province=innermongolia"
        }
    ]
};
...
var provincesDataProvider = {
    ...
    areas: [
        {
            "id": "CN-34",
            linkToObject: anhuiDataProvider,
            color: "#c8e4af",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-11",
            linkToObject: beijingDataProvider,
            color: "#93c370",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-50",
            linkToObject: chongqingDataProvider,
            color: "#93c370",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-35",
            linkToObject: fujianDataProvider,
            color: "#c8e4af",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-44",
            linkToObject: guangdongDataProvider,
            color: "#6aa24f",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-62",
            linkToObject: gansuDataProvider,
            color: "#93c370",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-45",
            linkToObject: guangxiDataProvider,
            color: "#93c370",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-52",
            linkToObject: guizhouDataProvider,
            color: "#6aa24f",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-46",
            linkToObject: hainanDataProvider,
            color: "#6aa24f",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-13",
            linkToObject: hebeiDataProvider,
            color: "#6aa24f",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-41",
            linkToObject: henanDataProvider,
            color: "#93c370",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-91",
            linkToObject: hongkongDataProvider,
            color: "#6aa24f",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-23",
            linkToObject: heilongjiangDataProvider,
            color: "#93c370",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-43",
            linkToObject: hunanDataProvider,
            color: "#487d21",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-42",
            linkToObject: hubeiDataProvider,
            color: "#6aa24f",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-22",
            linkToObject: jilinDataProvider,
            color: "#6aa24f",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-32",
            linkToObject: jiangsuDataProvider,
            color: "#93c370",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-36",
            linkToObject: jiangxiDataProvider,
            color: "#93c370",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-21",
            linkToObject: liaoningDataProvider,
            color: "#93c370",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-64",
            linkToObject: ningxiaDataProvider,
            color: "#6aa24f",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-63",
            linkToObject: qinghaiDataProvider,
            color: "#6aa24f",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-61",
            linkToObject: shaanxiDataProvider,
            color: "#487d21",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-51",
            linkToObject: sichuanDataProvider,
            color: "#c8e4af",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-37",
            linkToObject: shandongDataProvider,
            color: "#487d21",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-31",
            linkToObject: shanghaiDataProvider,
            color: "#487d21",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-14",
            linkToObject: shanxiDataProvider,
            color: "#9ACE6D",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-12",
            linkToObject: tianjinDataProvider,
            color: "#93c370",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-71",
            linkToObject: taiwanDataProvider,
            color: "#6aa24f",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-65",
            linkToObject: xinjiangDataProvider,
            color: "#487d21",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-54",
            linkToObject: xizangDataProvider,
            color: "#93c370",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-53",
            linkToObject: yunnanDataProvider,
            color: "#487d21",
            passZoomValuesToTarget: true
        },
        {
            "id": "CN-33",
            linkToObject: zhejiangDataProvider,
            color: "#6aa24f",
            passZoomValuesToTarget: true
        },
        {
            id: "CN-15",
            linkToObject: neimengDataProvider,
            color: "#c8e4af",
            passZoomValuesToTarget: true
        }]
};